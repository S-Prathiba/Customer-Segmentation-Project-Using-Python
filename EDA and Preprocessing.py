...
try:
    ...
    df = pd.read_csv(r"D:\customer segmentation//customer_segmentation_large_dataset.csv")
...
filepath = "D:\customer segmentation//customer_segmentation_large_dataset.csv"
...
with open('D:\customer segmentation/kmeans_model.pkl', 'wb') as file:
...
with open('D:\customer segmentation/hierarchical_clustering_labels.pkl', 'wb') as file:
...
with open('D:\customer segmentation/dbscan_model.pkl', 'wb') as file:
